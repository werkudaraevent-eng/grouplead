...
export const CHANGELOG: ChangeEntry[] = [
  {
    ...
    items: [
      { kind: "baru", text: "Form laporan punya field Rekaman pertemuan di kartu Lampiran. Rekam pertemuan dengan Memo Suara di iPhone (aplikasi bawaannya tahan layar terkunci dan telepon masuk), lalu ketuk Unggah rekaman dan pilih berkasnya. Maksimal 3 rekaman, 50 MB per berkas, dengan progres unggah yang terlihat." },
