...
export const CHANGELOG: ChangeEntry[] = [
  {
    ...
    items: [
      ...
      { kind: "baru", text: "Tombol “Lihat semua” di kaki kartu membuka seluruh baris. Baris yang bisa dijawab oleh daftar (industri, jenis aktivitas, atau sales pada Aktivitas; sales pada Laporan) bisa diketuk untuk membuka daftar itu, sudah tersaring baris dan periodenya." },
