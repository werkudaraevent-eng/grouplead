...
export const CHANGELOG: ChangeEntry[] = [
  {
    ...
    items: [
      ...
      { kind: "baru", text: "Atur widget: geser urutan (tekan dan tahan di ponsel, Alt + panah dengan keyboard), tarik sudut kanan bawah untuk mengubah ukuran per sel (1×1, 2×1, 1×2, 2×2; tiap kartu punya ukuran minimum), sembunyikan, tampilkan lagi. Susunan diingat per orang di semua perangkat." },
