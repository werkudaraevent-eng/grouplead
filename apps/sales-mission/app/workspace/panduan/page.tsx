...
const PARTS: Part[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Tanya AI: kalau admin menyalakannya, di baris saringan Ringkasan ada tombol Tanya AI yang membuka panel samping (di ponsel: lembar dari bawah) untuk bertanya tentang periode dan sales yang sedang disaring (“siapa yang belum ada laporan minggu ini?”). Jawabannya dari angka yang sama dengan kartu-kartu Ringkasan, dibatasi cakupan lihatmu, dan pertanyaan lanjutan dipahami dalam konteks pertanyaan sebelumnya. Bukan untuk mengubah data; hanya menjawab.",
