...
const PARTS: Part[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Kolom tulisan panjang seperti Ringkasan pertemuan tumbuh mengikuti tulisanmu, jadi kalimat pertama tidak hilang ke atas. Mau menulis berpoin: ketik “1. ” atau “- ” lalu Enter, dan baris berikutnya melanjutkan tandanya sendiri; Enter sekali lagi pada butir yang masih kosong mengakhiri daftarnya, dan Shift+Enter memberi baris baru tanpa tanda.",
      "Gaya komunikasi (DISC): kalau admin menyalakannya di Pengaturan → Aktivitas, tiap kontak yang ditemui bisa diberi tipe DISC sesuai pelatihan: satu huruf Utama (D Dominance, I Influence, S Steadiness, C Conscientiousness) dan, kalau terlihat, satu huruf Pendamping; ini perkiraanmu setelah bertemu, bukan hasil tes, dan selalu opsional. Pilih hurufnya dan cara menghadapinya muncul sebagai pengingat; tambahkan catatanmu sendiri (misal “minta angka tertulis dulu”). Hasilnya tampil di halaman aktivitas untuk semua anggota unit, ikut ke kontak di LeadEngine, terisi otomatis di kunjungan berikutnya ke orang yang sama, dengan nama penilai dan tanggalnya, dan ikut dalam ekspor laporan di sheet Kontak. Tidak pernah tampil di tautan publik atau di layar untuk tamu.",
      ...
      "Salah nama kontak atau alamat padahal laporan sudah dikirim? Tidak perlu tarik kembali: Ubah aktivitas tetap bisa merapikan keterangan kunjungan yang sudah selesai (kontak janji temu, alamat, industri, tujuan). Jadwal dan timnya tidak diubah lagi. Siapa yang benar-benar ditemui diubah lewat Ubah laporan → Ketemu siapa.",
      ...
      "Brief AI harian: kalau admin menyalakannya di Pengaturan → Aturan aktivitas, AI menulis brief tentang hari itu dalam tiga bagian — Perlu ditindak (klien berminat yang tindak lanjutnya belum jalan atau sudah lewat, laporan tertunda, prospek lewat tanggal, peluang yang belum dikirim ke LeadEngine), Yang terdengar di lapangan (tema dari isi laporan: kebutuhan klien, produk yang diminati, kompetitor yang disebut, siapa yang ditemui, perubahan dibanding kunjungan sebelumnya), dan Rekomendasi (satu sampai tiga langkah yang menyebut klien atau orangnya). Angkanya tetap dihitung aplikasi, bukan oleh AI, jadi selalu bisa dicek di kartu lain; kalimatnya disusun dari isi laporan yang kamu tulis, jadi tulis ringkasan pertemuan dengan jujur dan lengkap. Brief lengkapnya ada di tab Insight di halaman Laporan, dengan daftar hari 30 hari terakhir (Hari ini paling atas) sehingga brief hari sebelumnya masih bisa dibaca; poin yang lahir dari laporan tertentu punya tautan Lihat laporan. Di papan Ringkasan, kartu Insight hanya menampilkan tiga poin terpenting dan tombol Baca brief lengkap. Tombol Bagikan ke WhatsApp di tab Insight mengirim brief-nya sebagai teks ke grup. Brief hari ini dibuat tiap pagi pada jam yang diatur admin dan diperbarui saat ada laporan baru masuk; Buat ulang hanya untuk hari ini dan hanya untuk admin. Siapa yang melihatnya diatur di Role & Izin, modul Insight AI: cakupan Semua berarti brief unit, Tim atau Sendiri berarti tentang orang dalam cakupanmu. AI bisa keliru; angkanya selalu ada di kartu lain untuk dicek.",
      "Tanya AI: kalau admin menyalakannya, di baris saringan Ringkasan ada tombol Tanya AI yang membuka panel samping (di ponsel: lembar dari bawah) untuk bertanya tentang periode dan sales yang sedang disaring (“siapa yang belum ada laporan minggu ini?”). Jawabannya dari angka yang sama dengan kartu-kartu Ringkasan ditambah daftar di baliknya: aktivitas dan laporan pada periode itu, janji temu hari ini dan besok, prospek yang jatuh tempo, dan daftar sales, semuanya dibatasi cakupan lihatmu. Jadi “kunjungan hari ini ke mana saja” atau “siapa yang belum ada laporan” bisa dijawab. Daftar yang panjang dipotong dan AI menyebutkannya. Pertanyaan lanjutan dipahami dalam konteks pertanyaan sebelumnya. Percakapannya disimpan untuk akunmu sendiri: tutup panelnya, pindah halaman, atau buka lagi besok, percakapannya tetap ada. Riwayat membuka daftar percakapan tersimpan (judulnya dari pertanyaan pertama) — ketuk untuk melanjutkan, Hapus untuk membuangnya, Percakapan baru untuk memulai dari awal. Saat panel dibuka, percakapan terakhir hari ini otomatis dilanjutkan. Percakapan disimpan 90 hari, lalu dihapus sendiri; tidak ada yang bisa membaca percakapanmu selain kamu. Bukan untuk mengubah data; hanya menjawab.",
      "Halaman Laporan mengumpulkan semua laporan yang boleh kamu lihat; Ringkasan menghitungnya sebagai kartu yang bisa disusun: Atur widget untuk menggeser (seret judul kartu), mengubah ukuran (seret sudut kanan bawah, atau pilih Ukuran cepat di ⋮ kartu; Ringkas untuk kartu angka), menyembunyikan, atau membuat kartu sendiri dari ukuran, pengelompokan, dan bentuk grafik. Admin bisa menjadikan susunannya bawaan semua akun lewat menu ⋯. Saringan periode dan sales di atas berlaku untuk semua kartu.",
      "Ekspor di halaman Laporan mengunduh laporan yang sedang tersaring, lengkap. Berkas Excel-nya punya tiga sheet: Laporan (satu baris per laporan, judul kolomnya mengikuti nama kolom di Form laporan unitmu, termasuk kolom tambahan buatan admin, ditambah keterangan aktivitasnya dan tautan ke laporannya; orang yang ditemui dapat kolomnya masing-masing — Kontak 1 · Nama, Kontak 1 · Jabatan, Kontak 1 · Telepon, Kontak 1 · Email, Kontak 1 · Pengambil keputusan, Kontak 1 · DISC, Kontak 1 · Catatan DISC, lalu Kontak 2 dan seterusnya — supaya bisa disaring dan diurutkan), Kontak (satu baris per orang yang ditemui, dengan DISC bila ada), dan Catatan pendukung (muncul hanya kalau ada catatan). Semua tanggal dan jam dalam WIB, dipisah kolom tanggal dan kolom jam. Foto dan rekaman ditulis sebagai nama berkas beserta tautannya; tautan berkas ini berlaku 7 hari sejak diekspor, jadi ekspor lagi kalau sudah lewat. Tautan laporan di kolom terakhir tidak kedaluwarsa tapi tetap minta login, jadi jangan bagikan berkas ekspornya ke luar unit. Ekspor CSV berisi sheet Laporan saja.",
      "Fitur baru diumumkan lewat dialog Yang baru saat kamu membuka Hari ini, sekali per akun: Coba sekarang membawa ke fiturnya, Nanti saja menutupnya, dan titik di menu Yang baru tetap ada sampai halamannya dibuka. Admin memilih apa yang diumumkan dan bisa mengumumkannya ulang setelah training di Pengaturan → Pengumuman.",
    ],
  ...
  },
  {
    ...
    points: [
      ...
      "Simpan tampilan (di komputer): setelah mengatur daftar, klik tombol Tampilan di ujung kanan baris filter, pilih Simpan tampilan, lalu beri nama. Tombol itu menyebut nama tampilan yang sedang tampil. Buka untuk memilih tampilan lain (yang sedang tampil diberi centang, yang bawaan diberi bintang) atau Tampilan awal untuk kembali ke daftar seperti saat pertama dibuka. Tampilanmu hanya terlihat olehmu.",
      "Ubah daftar setelah memilih sebuah tampilan, lalu pilih Simpan perubahan di menu Tampilan untuk memperbaruinya, atau Simpan sebagai tampilan baru. Di menu yang sama kamu bisa mengubah nama tampilan itu, menjadikannya bawaan, atau menghapusnya (Batalkan di notifikasi mengembalikannya). Tampilan bawaan hanya dipakai saat daftar pertama kali dibuka di sebuah browser; tautan dan daftar yang diingat selalu didahulukan.",
      "Kolom: tombol Kolom memilih kolom yang tampil dan urutannya (centang, seret, atau Susunan awal); nama perusahaan selalu tampil. Setiap sel satu baris, dan teks yang terpotong tampil utuh saat kursor diarahkan ke atasnya. Di komputer tabel memenuhi layar dan bergulir di dalam kartunya: judul kolom tetap di atas, tombol halaman tetap di bawah, dan selama ada filter yang menyala jumlah hasilnya (misalnya 12 dari 170 aktivitas) tampil di kiri bawah. Tabel yang lebih lebar dari layar digeser ke samping dengan penggeser di dasar kartu, sementara nama dan tombol Aksi tetap di tempat.",
      "Urutan: klik judul kolom untuk mengurutkan dari A ke Z, klik lagi untuk kebalikannya, dan sekali lagi untuk kembali ke urutan bawaan. Panah abu-abu menandai kolom yang memegang urutan bawaan (Jadwal: terdekat dulu; Hubungi lagi: jatuh tempo dulu; Status di Laporan: terbaru dulu); arahkan kursor ke judulnya untuk membaca urutannya.",
      "Di HP daftar tampil sebagai kartu; tampilan tersimpan dipilih di bagian atas lembar Filter. Saat kamu menggulir kartu ke bawah, kolom cari dan chip menyingkir; gulir sedikit ke atas dan keduanya muncul lagi di bawah bilah atas. Menyimpan tampilan dan memilih kolom dilakukan di komputer.",
    ],
    link: { href: paths.activities(), label: "Buka daftar aktivitas" },
  },
  {
