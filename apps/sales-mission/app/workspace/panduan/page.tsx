...
const PARTS: Part[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Kalender dan Papan live memperlihatkan hal yang sama dari sudut waktu dan dari sudut tim. Di Kalender, chip Semua dan Saya serta pilihan Sales menyaring siapa yang digambar; pilihan terakhir diingat per orang. Admin bisa membuat tautan jadwal publik dari Kalender: manajemen membukanya di browser tanpa login, baca-saja, dan tautannya bisa dicabut dari Pengaturan → Tautan publik.",
    ],
  ...
  },
  {
    ...
    points: [
      ...
      "Insight hari ini: kalau admin menyalakannya di Pengaturan → Aturan aktivitas, di atas Ringkasan ada kartu berisi 3 sampai 5 kalimat yang ditulis AI dari angka aplikasi: laporan yang masuk hari ini, laporan tertunda, prospek yang lewat tanggal hubungi lagi, dan perbandingan dengan minggu lalu. Dibuat tiap pagi pada jam yang diatur admin dan diperbarui saat ada laporan masuk. Siapa yang melihatnya diatur di Role & Izin, modul Insight AI: cakupan Semua berarti insight unit, Tim atau Sendiri berarti tentang orang dalam cakupanmu. Poin yang bisa dijawab daftar bisa diketuk. AI bisa keliru; angkanya selalu ada di kartu lain untuk dicek.",
      "Tanya AI: kalau admin menyalakannya, di bawah Insight hari ini ada kotak pertanyaan tentang periode dan sales yang sedang disaring (“siapa yang belum ada laporan minggu ini?”). Jawabannya dari angka yang sama dengan kartu-kartu Ringkasan, dibatasi cakupan lihatmu, dan pertanyaan lanjutan dipahami dalam konteks pertanyaan sebelumnya. Bukan untuk mengubah data; hanya menjawab.",
