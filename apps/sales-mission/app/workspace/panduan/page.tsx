...
const PARTS: Part[] = [
  ...
  },
  {
    ...
    points: [
      ...
      "Setelah laporan dikirim, tekan Bagikan ke WhatsApp di halaman aktivitas: teksnya sudah tersusun dalam format grup beserta foto pertama laporan, tinggal pilih grupnya. Format teksnya diatur admin di Pengaturan → Aturan aktivitas → Laporan kunjungan.",
