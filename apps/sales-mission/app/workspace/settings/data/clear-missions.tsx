    ...
    <section className="max-w-2xl overflow-clip rounded-xl border border-[var(--danger-foreground)]/30 bg-card">
      ...
      <div className="space-y-4 px-5 py-5">
        <p className="text-sm leading-relaxed text-foreground">
          Memindahkan <strong>{count} aktivitas</strong> beserta laporan kunjungan, penugasan, catatan pendukung, usulan
        ...
        {!canDelete && (
          <p className="rounded-md border border-dashed px-3 py-2.5 text-sm text-muted-foreground">
            Peran Anda belum punya izin <em>hapus</em> pada modul Aktivitas. Berikan dulu di LeadEngine → Pengaturan →
        ...
        <div className="flex justify-end">
          ...
          >
            ...
            Pindahkan {count} aktivitas ke sampah
          </Button>
        </div>
      </div>
    </section>
