...
export function VisitReportForm({
  ...
  return (
    <div className="max-w-3xl space-y-4">
      ...
      {/*
        Action row, stuck to the bottom of the content column. It used to be
        fixed to the viewport, which laid it over the sidebar and let the
        "belum lengkap" line collide with the buttons. Sticky keeps it in
        the column, and the status lines sit above the buttons so nothing
        overlaps.
      */}
