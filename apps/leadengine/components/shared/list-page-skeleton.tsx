 ...
 * resolves: the header, the toolbar and rows on a desk; the header, the
...
export function ListPageSkeleton() {
    return (
        <div data-fluid-page className="flex w-full flex-col py-6" aria-busy="true">
            <div className="mb-4 flex items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
                <div className="space-y-2">
                    <div className="h-7 w-40 animate-pulse rounded-md bg-muted" />
                    <div className="hidden h-4 w-64 animate-pulse rounded-md bg-muted md:block" />
                </div>
