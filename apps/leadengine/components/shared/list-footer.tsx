...
import { PAGE_SIZES, lastPage, loadMoreStep, pageRange, type PageSize } from "@/lib/lists/list-state"
 ...
 * with the total ("1–25 of 1,196 contacts") and previous / next, all at the
...
export function ListFooter({
    ...
    return (
        <div className={cn("shrink-0 border-t border-border bg-card text-[13px] text-muted-foreground", className)}>
            <div className="hidden h-14 items-center justify-end gap-6 px-4 md:flex">
