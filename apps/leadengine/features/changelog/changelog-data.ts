...
export const CHANGELOG: ChangelogEntry[] = [
    {
        ...
        items: [
            ...
            { type: "improvement", text: "On a phone the Dashboard's pipeline, company and date filters are one row of buttons under its name that you swipe sideways. The date range opens a panel from the bottom with the quick ranges and a calendar." },
            ...
            { type: "improvement", text: "On a phone, the ⋮ at the top right of Pipeline now has Switch pipeline, to open another pipeline (and New pipeline, if your role can create one), because the list of pipelines at the left side is not shown there. The Filter panel now fits the screen too." },
