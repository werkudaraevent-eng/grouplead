...
export const CHANGELOG: ChangelogEntry[] = [
    {
        ...
        items: [
            ...
            { type: "improvement", text: "On a phone the Dashboard's filters work like the ones on Contacts and Companies: tap Filter under the dashboard's name and a panel comes up from the bottom where you choose the pipeline, the business unit and the date range (the quick ranges, or a start and an end day on the calendar). The dashboard changes as you tap. The number on the button says how many filters differ from how the dashboard first opens, and what you chose is listed under the button: tap ✕ to remove one, or Clear all to go back to the start." },
